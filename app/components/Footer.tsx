const footerLinks = {
  ...
  "Use Cases": [
    { label: "Job Search", href: "#use-cases" },
    { label: "Freelancing", href: "#use-cases" },
    { label: "Business Development", href: "#use-cases" },
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-6">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-slate-500">
              The all-in-one platform for opportunity discovery, qualification,
              outreach, and pipeline management.
            </p>
          </div>
